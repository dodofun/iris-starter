...
func (c *greeterClient) SayHello(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedGreeterServer) SayHello(context.Context, *UserRequest) (*UserResponse, error) {
